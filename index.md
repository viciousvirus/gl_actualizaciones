...
Se han hecho muchas preguntas en el evento que tomo lugar el 6/3, que han sido recompiladas (por el usuario Kibble), traducidas y publicadas (por ViciousVirus), y resumidas (por Pech y Sensei).
Esto no es toda la conversación completa, si quieres ver más detalles por favor dale [clic aqui](https://viciousvirus.github.io/gl_6-3-22)
...
Será difícil, Marido se comprometió a ello, si no fuese así entonces usaremos una copia antigua que tenemos pero es dudoso. La estructura de la data es diferente al nuestro, surgiendo problemas de compatibilidad y que se debe analizar. Haremos lo mejor posible y más adelante una encuesta para decidir si los jugadores quieren mantener el progreso.
